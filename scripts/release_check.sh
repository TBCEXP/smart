...
for s in erp_verify.sh prod_readiness_check.sh release_check.sh deploy_verify.sh deploy_preflight.sh onboard_checklist.sh ready.sh go_live.sh export_blockers.sh delivery_complete.sh setup_github_deploy.sh setup_tab2_keys.sh production_start.sh; do
