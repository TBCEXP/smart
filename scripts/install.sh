...
echo "      2. bash scripts/ready.sh http://127.0.0.1:8000"
echo "      3. bash scripts/onboard_checklist.sh http://127.0.0.1:8000"
echo "      4. bash scripts/prod_onboard.sh http://127.0.0.1:8000 --full"
echo "      5. 配置 HTTPS: certbot --nginx -d crm.yourdomain.com"
