...
echo "  4. 阅读 docs/VPS_ONBOARDING.md"
echo "  5. GitHub Secrets: VPS_HOST / VPS_USER / VPS_SSH_KEY（自动部署）"
echo "  6. sudo bash scripts/setup_https.sh crm.yourdomain.com"
echo "  7. bash scripts/prod_onboard.sh https://crm.yourdomain.com --full"
