...
def catalog_dict(
    ...
    return {
        ...
        "doc_type": doc.doc_type or "catalog",
...
async def seed_catalog_documents(db: AsyncSession) -> int:
    ...
    seeds = [
        ...
        {
            "title": "2026 烘焙模具 FOB 报价单",
            "title_en": "Bakeware FOB Quote Sheet 2026",
            "category_l3": "bakeware",
            "doc_type": "quote",
            "file_url": "r2://smart-crm/quotes/bakeware-fob-2026.pdf",
            "pages": 8,
            "file_size_mb": 1.2,
            "authorized_emails": ["customer@example.com"],
        },
    ...
    for i, seed in enumerate(seeds):
        ...
        db.add(
            CatalogDocument(
                ...
                doc_type=seed.get("doc_type", "catalog"),
